...
<p align=left><b>VESSEL TYPE :</b></p>
 <div class="btn" data-toggle="buttons">
			...
			<label class="btn btn-primary col-md-2 p">
				<input type="checkbox" autocomplete="on" name="pvc">
				<span class="glyphicon glyphicon-ok"></span>
				<b>PVC</b>
			</label>
	...
	<div class="row">
      <div class="col-lg-12">
        ...
        <th style="text-align:center">Total Cell:</th>
              ...
              <tbody>
                  <tr id="tr_0">
                       <td><input type="text" name="cmno" class="form-control" placeholder="CM No" title="CM No"/></td>
                      <td><input type="text" name="nocontainers" class="form-control" placeholder="No.Containers" title="No.Containers"/></td>
                      <td><input type="text" name="yield" class="form-control" placeholder="Yield/Cont" title="Yield/Cont"/></td>
                       <td><input type="text" name="cellyield" class="form-control" placeholder="Cell Yield/sq.cm" title="Cell Yield/sq.cm"/></td>
                        <td><input type="text" name="totalcell" class="form-control" placeholder="Total Cell" title="Total Cell"/></td>
...
<div class="row">
<div class="well well-sm " style =" width:32%;margin-left:3%">

<div class="form-group"  >

<label class="control-label col-sm-4" for="Medium of cells" style="margin-left:-9%;">Medium #</label>
<div class="col-sm-3" style="margin-left:-6%">
<input type ="text" name="medium" style = "border-bottom:1px dashed black; width:140px;" title="Medium" placeholders="Medium" >
</div>	
<div class="col-sm-5" style="margin-left:14%">
<input type="text" class="form-control" name="medium_r" title="Medium_R"placeholder="R" >

</div><br><br>
<label class="control-label col-sm-5" for="Medium of cells" style="margin-left:-9%;">Antibiotics 1 #</label>
<div class="col-sm-3" style="margin-right:7%;margin-left:-7%">
...
<div class="well well-sm" style =" width:82%;margin-left:2%;margin-top:-27%">
<div class="form-group">
<label class="control-label col-sm-4" for="Serum" style="margin-left:-12%">Serum #</label>
<div class="col-sm-3" style="margin-right:7%;margin-left:-5%">

<input type ="text" name="serumNo" style = " border-bottom:1px dashed black; width:70px; "  >
<p style="margin-top:-20px;margin-left:70px">%</p>
</div>
<div class="col-sm-1" style="margin-left:-10%">
<input type ="text" name="serumPer" style = " border-bottom:1px dashed black; width:50px; "  >
...
<label class="control-label col-sm-6" for="Serum" style="margin-left:-18%">Antibiotics 2 #</label>
<div class="col-sm-1" style="margin-right:7%;margin-left:-7%">
<input type ="text" name="antibiotics2" style = " border-bottom:1px dashed black; width:100px; " >
</div>
...
<div class="col-md-4 col-md-offset-8" style="width:34%;margin-top:-11%;">

<div class="well well-sm" style =" margin-right:8%">
<div class="form-group">
<label class="control-label col-sm-12" style="margin-left:-168px" >Sodium Bicarbonate #:</label>
...
<label class="control-label col-sm-2" style="margin-left:3px" >Other:</label>
  ...
  <div class="panel panel-default" style="width:96% ;margin-left:2%">
    <div class="panel-heading">
      <h4 class="panel-title">
        <button type="button" class="accordion-toggle btn" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style=" float:center;width:95%"<span class="glyphicon glyphicon-eject"></span>>
          Day #1   
        </button>
        <a href="#" data-perform="panel-dismiss" class="btn btn-danger btn-md pull-right"> <i class="fa fa-times" ></i></a>
      </h4>
    </div>
...
<div class="well well-sm" style =" margin-right:8%;margin-top:-35%">
<div class="form-group">
...
<label for="text" class="control-label col-xs-4"style="text-align:left ;margin-left:1%">Media Conditioning, Additions and Remarks :</label>
<div class="col-xs-8"style="margin-left:-3%;height:-750%">
<textarea style="height:750%" type="text" placeholder="Media Conditioning, Additions and Remarks" title="Media Conditioning, Additions and Remarks" class="form-control" rows="14" cols="50" ></textarea>
  ...
  <div class="panel panel-default template" style ="width:96% ;margin-left:2%">
    <div class="panel-heading">
      <h4 class="panel-title">
        <button class="accordion-toggle btn" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" style=" float:center;width:95%" >
          Day #2 
        </button>
        <a href="#" data-perform="panel-dismiss" class="btn btn-danger btn-md pull-right"><i class="fa fa-times" ></i></a>
      </h4>
...
$(document).ready(function () {
    ...
    {
        var tempTr = $('<tr><td><input type="text" name="cmno" class="form-control" placeholder="CM No" title="CM No"/></td><td><input type="text" name="nocontainers" class="form-control" placeholder="No.Containers" title="No.Containers"/></td><td><input type="text" name="yield" class="form-control" placeholder="Yield/Cont" title="Yield/Cont"/></td><td><input type="text" name="cellyield" class="form-control" placeholder="Cell Yield/sq.cm" title="Cell Yield/sq.cm" /></td><td><input type="text" name="totalcell" class="form-control" placeholder="Total Cell" title=""/></td><td><span class="glyphicon glyphicon-minus addBtnRemove" id="addBtn_' + i + '"></span></td></tr>').on('click', function () {
           /* $(this).closest('tr').remove();  */
