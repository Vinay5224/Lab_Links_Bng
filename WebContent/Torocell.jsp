...
$( document ).ready(function() {
	...
	$("#Arr").val("");
	$("#Arr").val(Counts);
	var daysHtml="<button id=day"+countDays+" type=button class=btn btn-info data-toggle=collapse data-target=#demo"+countDays+" style=width:100%;><span id=currentSnoId"+countDays+">S.no :"+countDays+"</span><span id=enteredDate"+countDays+"></span><span style=float:right>&#9660;</button>"
	daysHtml+="<div id=demo"+countDays+" class=collapse> <center> <span id=errorDate"+countDays+"></span><center> <div class=row><div class=col-md-3 col-md-offset-8><button type=button value=remove style=float:left onclick=removeDay('"+countDays+"')>Remove</button> "
	...
	daysHtml+="<div class=col-xs-8><input type=text class=form-control name=PreviousDate"+countDays+" onkeyup=changeDate('PreviousDate"+countDays+"',"+countDays+") id=PreviousDate"+countDays+" onblur=validateDate('PreviousDate"+countDays+"',"+countDays+")>(DD/MM/YYYY)(Ex:07/09/2017)<input type=hidden name=noOfDays> </div>"
	...
	daysHtml+="<div class=col-xs-2style=margin-left:-1%><input type=text class=form-control name=gms"+countDays+" placeholder=Gms/L>"
	daysHtml+="</div><label for=text class=control-label col-xs-3 style=margin-left:1%>OD of Test Sample :</label>"
	daysHtml+="<div class=col-xs-3 style=margin-left:3%><input type=text class=form-control name=odOfTestSample"+countDays+" placeholder='OD of Test Sample'>"
		...
		.submit(
				function(event) {
					...
					if (tcc != null && tcc != ""
						...
						alert("Mandatory fields 'Tcc','Date' must be entered");
						return false;
					}
...
<a style="float: left;width: 150px;margin-left: -600px;" href="LablinksAnalytics.jsp" type="button" class="btn btn-default btn-circle">Analytics</a>
...
<div class="well well-sm col-sm-5  col-sm-offset-3 rare" >
...
<p align=left><b>VESSEL TYPE :</b></p>
 ...
 <div class="form-group">
      <div class="col-xs-2">
        ...
        <input class="form-control" id="no_of_inlet_ports" name="no_of_inlet_ports" type="text" title="No of Inlet ports" placeholder="No of Inlet ports">
      </div>
      <div class="col-xs-3">
        <label for="ex2">No of Outlet Ports(Dipping)</label>
        <input class="form-control" id="no_of_outlet_ports" name="no_of_outlet_ports" type="text" title="No of Outlet Ports" placeholder="No of Outlet Ports">
      </div>
      <div class="col-xs-2">
        <label for="ex3">Cell Spreader</label>
        <input class="form-control" id="Cell_spreader" name="Cell_spreader" type="text" title="Cell Spreader" placeholder="Cell Spreader">
      </div>

      <div class="col-xs-3">
        <label for="ex4">Cell Sampler CoverSlip</label>
        <input class="form-control" id="Cell_sampler_coverSlip" name="Cell_sampler_coverSlip" type="text" title="Cell Sampler CoverSlip" placeholder="Cell Sampler CoverSlip">
      </div>
...
<div class="form-group">
     ...
     <div class="col-xs-2">
        ...
        <input id="no_matrix" class="form-control" name="no_matrix" type="text" title="No Matrix" placeholder="No Matrix">
      </div>
...
<label for="checkbox8"><b>Carbonate Left </b></label>
            <input type="text" id="carbonate_left" name="carbonate_left" class="form-control" title="Carbonate Left"  placeholder="Carbonate Left"/>
...
<label for="checkbox9"><b>Carbonate Right </b></label>
            <input class="form-control" id="carbonate_right" type="text" name="carbonate_right" title="Carbonate Right" placeholder="Carbonate Right"/>
...
<div class="col-sm-2">
 ...
 <div class="form-group phdo">
     ...
     <label class="btn btn-primary col-xs-4 h">
			...
			<b>DO</b>    
        <label for="make">Make</label>
        <input class="form-control" placeholder="Do Make" name="do_Make" type="text">
      </div></label>
        ...
        <th style="text-align:center">Total cell:</th>
              ...
              <tbody>
                  <tr id="tr_0">
                      ...
                      <td><input type="text" name="nocontainers" class="form-control nocontainers" /></td>
...
<input type ="text" name="medium_of_cells" title="Medium Of cells"  style = "border-bottom:1px dashed black; width:150px;" placeholder="Medium Of cells:">
</div>	
<div class="col-sm-2" style="margin-left:-1%">
<input type="text" class="form-control" name="mediumofcells_R" title="Medium Of cells_R" placeholder="Medium Of cells R" >

</div>
<label class="control-label col-sm-1" for="Serum" style="margin-left:-3%">Serum :</label>
<div class="col-sm-1" style="margin-right:7%;margin-left:-2%">

<input type ="text" name="serum" title="Serum"  style = " border-bottom:1px dashed black; width:150px; "  placeholder="Serum :">
<p style="margin-top:-20px;margin-left:140px">%</p>
</div>	
<div class="col-sm-2"style="margin-left:-1%">

<input type="text" class="form-control" name="serum_r" id="Serum"  title="Serum_R" placeholder="Serum R" >
</div>
</div>
</div>
...
<input type="text" class="form-control" name="antibiotics2_R" title="Antibiotics2_R" placeholder="R" >
</div>
...
<div class="well well-sm" style ="width:96% ;margin-left:2%;">
<div class="form-group"  >
<p align="center"><b  >Observation, Sampling and Quality Control tests. Note that All samples should be labeled as "Sample TCC xx Day xxx Date xxx "</b></p> 
</div>
</div>
...
<div class="well well-sm" style ="border:df1010 ;width:96% ;margin-left:2%">
<div class="form-group">
<label for="text" class="control-label" style ="margin-left:0%" ><b>CONTROL & APPROVAL : This Form comes to effect from 1st january 2014.</b></label><br><br>
