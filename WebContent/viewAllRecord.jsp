...
function filter()
{
	...
	var pvcId=$('#pvcId').is(":checked");	
	var ppId=$('#ppId').is(":checked");
	/* alert($('#ppId').attr('checked', true)) */
	console.log($('#ppId').is(":checked"))
		...
		$.ajax({			 
		      ...
		      success: function(data) {
				...
				if(data=="true")
				{
					...
					var id=$("#editIdd").val();
					window.location = "ViewSelectedRecord.jsp?id="+id;	
					$("#error").hide();
				}
				else
					{
...
<!-- Edit Model End Here -->
<a href="Torocell.jsp"><p style="height:60px; width:200px; background-image:url(Lablinkslogo.png); background-repeat:no-repeat; margin-top:10%;"> </p></a>
</div>

<div class="col-md-6" style="background-color:rgb(204,204,204); height:120px;">
<h2 style="color:rgb(0,0,0); text-align:center; margin-top:8%;"><b>TOROCELL CELL CULTURE CARD</b></h2>


</div>
<div class="col-md-3 " style="background-color:rgb(204,204,204); height:120px;">
<p style="height:80px; width:200px; background-image:url(clogo.png); background-repeat:no-repeat; margin-top:8%; m"> </p>
</div>
...
<a href="Torocell.jsp" style="float: left;">
          <span title="Back to Home" class="glyphicon glyphicon-circle-arrow-left" style="margin-top:-10px;margin-bottom: 8px;">Back</span>
        </a> 
  <input type="text" class="form-control" id="tcc" placeholder="TCC"></p>
</div>
...
<label class="checkbox-inline"><input id="pvcId" type="checkbox" >PVC/PP/GL/SS SUSPENSION</label>

<label class="checkbox-inline">
<input id="ppId" type="checkbox">PP/SS MACROMATRX</label>
...
<a href="Microbial.jsp" type="button">Microbial Cell Record </a>
...
<button type="submit" class="btn btn-info" value="SyncDb" name="syncDb">
<span>SyncDb</span>
</button>
</form> -->
</div>
...
<div class="table-responsive">
    <table id="productSizes" class="table">
        <thead>
            <tr>
                <th class="col-xs-3">TCC</th>
              <th class="col-xs-2">Date</th>
                <th class="col-xs-2">PVC/PP/GL/SS SUSPENSION</th>
                <th class="col-xs-2">PP/SS MACROMATRX</th>
