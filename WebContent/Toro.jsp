...
<div class="col-xs-5">
<input type="text" class="form-control" name="tcc" id="uniqueTc">
</div>
</div>
</div>
...
<div class="col-xs-8">
<input type="text" class="form-control" name="Date" id="Date" id="uniqueDate">
...
<div class="col-xs-5">
<input type="text" class="form-control" name="previoustcc" id="Stcc" >
</div>
</div>
</div>
...
<label for="text" class="control-label col-xs-4">Date :</label>
<div class="col-xs-8">
<input type="text" class="form-control u" name="PreviousDate" id="SDate" >
 ...
 <button class="btn btn-success btn-lg pull-right" type="submit"  id="Ssave">show the details</button>
 </form>
 </div>
