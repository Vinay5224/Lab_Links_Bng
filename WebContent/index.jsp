...
$( document ).ready(function() {
	...
	var daysHtml="<button type=button class=btn btn-info data-toggle=collapse data-target=#demo"+countDays+" style=width:100%;>Day"+countDays+"</button>"
...
<form action="Torocell" class="form-horizontal" method="post" id="totForm">
<div class="container">
...
<div class="col-xs-5">
<input type="text" class="form-control" name="tcc" id="uniqueTcc" onblur="checkUniquOrNot()">
</div>
</div>
</div>
...
<div class="col-xs-8">
<input type="text" class="form-control" name="Date" id="uniqueDate" onchange="checkUniquOrNot()">
...
<div class="form-group">
     ...
     <div class="col-xs-2">
      ...
      <div class="col-xs-2">
        ...
        <input class="form-control" name="otherTypeVal" type="text">
      </div>
      
      <div class="funkyradio">

<div class="funkyradio-primary col-md-2"style="float:center;margin-top:-6%;margin-bottom:2%;margin-left:35%">
            <input type="text" name="carbonate_left" class="form-control"/>
...
<div class="funkyradio-primary col-md-2"style="float:center;margin-top:-8%;margin-bottom:2%;margin-left:78%">
            <input class="form-control" type="text" name="carbonate_right"  />
...
<div class="col-sm-2">
     ...
     <div class="funkyradio-primary col-md-2"style="float:center;margin-top:-6%;margin-left:17%">
      ...
      <div class="col-sm-2"style="float:center;margin-top:-5%;margin-left:2%">
        ...
        <input class="form-control" name="ph_make" type="text">
      </div>
     ...
     <div class="funkyradio-primary col-md-2" style="float:center;margin-top:-6%;margin-left:57%">
      ...
      <div class="col-xs-2" style="float:center;margin-top:-5%;margin-left:2%">
        ...
        <input class="form-control" name="do_Make" type="text">
      </div>
      </div>
      </div>
      <div class="well well-sm" style ="margin-left:2%">
...
<div class="col-sm-2">
<input type="text" class="form-control" name="cells"  >

 </div>

<label class="control-label col-sm-2" for="Passage No" style="margin-left:-50px">Passage No:</label>
<div class="col-sm-2">
<input type="text" class="form-control" name="passageno"  >
</div>
...
<input type ="text" name="medium_of_cells" style = "border-bottom:1px dashed black; width:150px;" >
</div>	
<div class="col-sm-2" style="margin-left:-1%">
<input type="text" class="form-control" name="mediumofcells_R" placeholder="R" >

</div>
<label class="control-label col-sm-1" for="Serum" style="margin-left:-3%">Serum :</label>
<div class="col-sm-1" style="margin-right:7%;margin-left:-2%">

<input type ="text" name="serum" style = " border-bottom:1px dashed black; width:150px; "  >
<p style="margin-top:-20px;margin-left:140px">%</p>
</div>	
<div class="col-sm-2"style="margin-left:-1%">

<input type="text" class="form-control" name="serum_r" id="Serum" placeholder="R" >
</div>
</div>
</div>
...
<input type="text" class="form-control" name="totalNoofCellsceeded" >
</div>
...
<div class="col-sm-1" style="margin-right:7%;margin-left:-2%">
<input type ="text" name="medium" style = "border-bottom:1px dashed black; width:150px;" >
</div>	
<div class="col-sm-2" style="margin-left:-2%">
<input type="text" class="form-control" name="medium_r" placeholder="R" >
...
<input type="text" class="form-control" name="serumNo_R" id="Serum" placeholder="R" >
</div>
...
<input type="text" name="totalVolumeOfMedium">
</h4>
  </div>
...
<textarea type="text" name="settingUpCulture" class="form-control" rows="14" cols="10" ></textarea>
</div>
</div>
</div>
...
<div class="col-xs-3">
<input type="text" class="form-control u" name="designation1"  >
